...
export const EditElectionForm: React.FC<EditElectionFormProps> = ({
  election,
  onSubmit,
  onCancel,
  loading = false,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || "Failed to update election. Please try again.");
    }
  };
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Update election details and settings
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex space-x-4 pt-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 text-white font-medium px-6 py-3 rounded-lg transition-colors disabled:cursor-not-allowed flex items-center justify-center space-x-2"
            >
              {loading ? (
